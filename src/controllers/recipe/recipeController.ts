...
async function recipeController(req: Request, res: Response<AppResponseType>) {
  ...
  const storedIngredients = (
    await db.StoredIngredient.findAll({
...
export default withController({ methods: ['GET'], privateMethods: ['GET'], controller: recipeController });
